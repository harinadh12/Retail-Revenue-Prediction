...
plot_features <- function(tr1){
  ...
  p+geom_bar(mapping = aes(x=operatingSystem,y=totalRevenue),stat="identity")
  p+geom_bar(mapping = aes(x=browser,y=totalRevenue),stat="identity")
  p+geom_bar(mapping = aes(x=deviceCategory,y=totalRevenue),stat="identity")
